...
type Querier interface {
	...
	DocumentOrObjectById(ctx context.Context, db DBTX, id pgtype.UUID) ([]*DocumentOrObjectByIdRow, error)
	DocumentUpdate(ctx context.Context, db DBTX, arg *DocumentUpdateParams) (pgtype.UUID, error)
	...
	MetadataInsertBatch(ctx context.Context, db DBTX, arg *MetadataInsertBatchParams) (*MetadataInsertBatchRow, error)
	MetadataUpdateBatch(ctx context.Context, db DBTX, arg *MetadataUpdateBatchParams) (*MetadataUpdateBatchRow, error)
